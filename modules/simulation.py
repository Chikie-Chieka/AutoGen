...
def run_simulation(num_nurses: int = 3, timeline_duration: int = 15, supply_mode: str = "normal", event_description: str | None = None):
    """Main simulation for Goal A with rate/token optimizations."""
    logger, log_path = setup_logging()
    scenario = Scenario(timeline_duration=timeline_duration, supply_mode=supply_mode, logger=logger, event_description=event_description)
    scorer = Scorer()
